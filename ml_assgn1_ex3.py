...
#########################################
# Initialise trainable parameters theta to size 6 since have three new non-linear sets added
theta = np.zeros((6))
# /
...
theta_final, cost_vector = gradient_descent(
    X_normalized, y, theta, alpha, iterations)
